...
public class TextFileConverterTest {
    ...
    public void 텍스트파일을_Covlertter객체로_변환할_수_있다() {
        ...
        Assertions.assertEquals(coverletter.getApplicationHalf(), ApplicationHalf.SECOND_HALF);
        Assertions.assertEquals(coverletter.getApplicationType(), ApplicationType.JUNIOR);
